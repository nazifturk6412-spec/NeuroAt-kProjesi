...
// Alizade Begovic İmam Hatip Lisesi Çevresi Çöp Kutusu Konumları
// Lise yaklaşık konumu: Yenimahalle, Ankara (örnek koordinatlar)
...
const wasteBinLocations = [
    ...
    { lat: 39.9260, lng: 32.8365, name: 'Okul Girişi', address: 'Alizade Begovic İHL Önü', status: 'Aktif', capacity: 75 },
...
function initializeMap() {
    // Alizade Begovic İHL merkez koordinatları
    ...
    map.whenReady(() => {
        console.log('Harita yüklendi - Alizade Begovic İHL çevresi');
...
function addSchoolMarker() {
    ...
    schoolMarker.bindPopup(`
        <div class="marker-popup">
            <h4>🏫 Alizade Begovic İmam Hatip Lisesi</h4>
